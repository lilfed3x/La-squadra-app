...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (appSettings.appLogoUrl) {
      ...
      // NOTE: We do NOT update the manifest href dynamically anymore.
      // Modifying the manifest link at runtime breaks PWA installation on Android (Chrome).
      // The static manifest.json generated by VitePWA is sufficient and more stable.
    }
  }, [appSettings]);
